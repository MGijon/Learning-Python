...
fig.savefig("Leftventricle_Bulleye.png")

plt.show()

# source : https://matplotlib.org/devdocs/gallery/specialty_plots/leftventricle_bulleye.html#sphx-glr-gallery-specialty-plots-leftventricle-bulleye-py